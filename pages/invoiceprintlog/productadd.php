                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" placeholder="Name Product ..." name="product_name" autocomplete="OFF" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control kapital" type="text" placeholder="Product Code ..." name="product_code" autocomplete="OFF" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
