        ...
        <table>
            <tr>
                ...
                <td style="width: 30.6%; border-top:1px solid #000;border-right:1px solid #000;border-bottom:1px solid #000;border-left:0;padding: 5px;">
                    ...
                    <p style="line-height:1.6;margin:0; padding: 0;text-align: right;">PSC</p>
                    <p style="line-height:1.6;margin:0; padding: 0;text-align: right;">IWJR</p>
                ...
                <td style="width: 19.4%; border:1px solid #000;padding: 5px;">
                    ...
                    <p style="line-height:1.6;margin:0; padding: 0;text-align: right;"><?= $data['invoice_psc'] ? rupiah($data['invoice_psc']) : '-' ?></p>
                    <p style="line-height:1.6;margin:0; padding: 0;text-align: right;"><?= $data['invoice_iwjr'] ? rupiah($data['invoice_iwjr']) : '-' ?></p>
