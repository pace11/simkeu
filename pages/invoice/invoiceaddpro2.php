                                ...
                                <div class="col-md-12">
                                    <?php 
                                        if (isset($_POST['submit'])){
                                            ...
                                            if ($count == 0) {
                                                $invoice_number = '01';
                                                $id_invoice = $data_product['product_code'].'-01/INV/SD-SEN/'.get_romawi($month_now).'/'.$year_now;
                                            } else {
                                                if ($number <= 9) {
                                                    $invoice_number = '0'.$number;
                                                    $id_invoice = $data_product['product_code'].'-0'.$number.'/INV/SD-SEN/'.get_romawi($month_now).'/'.$year_now;
                                                } else {
                                                    $invoice_number = $number;
                                                    $id_invoice = $data['product_code'].'-'.$number.'/INV/SD-SEN/'.get_romawi($month_now).'/'.$year_now;
                                                }
                                            }
                                            ...
                                            $html = file_get_contents(url_file()."/charter.php?id=$id_invoice");
