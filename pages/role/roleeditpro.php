                                ...
                                <div class="col-md-12">
                                    <?php 
                                        if (isset($_POST['submit'])){
                                            $id         = $_POST['id'];
                                            $role_name  = $_POST['name_role'];
                                            $role_desc  = $_POST['desc_role'];
                    
                                            $insert = mysqli_query($conn, "UPDATE role_login SET
                                                    role_login_name         = '$role_name',
                                                    role_login_description  = NULLIF('$role_desc', '')
