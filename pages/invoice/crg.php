...
<body>
    ...
    <div style="width:100%;height: auto;box-sizing: border-box;">
        <div style="text-align: right;height: 100px;">
            ...
            <p style="padding:0;margin:0;font-size:27px;font-weight:bold;">PT SEMUWA DIRGANTARA</p>
        ...
        <table>
            <tr>
                <td style="width: 20%;padding: 5px;">
                    <p style="padding:0;margin:0;text-align:left;font-size:22px;font-weight:bold;">INVOICE</p>
                </td>
                <td style="width: 80%;">
        ...
        <table>
            ...
            <tr>
                ...
                <td style="width: 20%; border:1px solid #000;padding: 5px;">
                    <p style="margin:0; padding: 0;text-align: center;vertical-align: bottom;text-transform:uppercase;"><?= $data['invoice_total_hour'] && $data['invoice_total_hour'] != '-' ? $data['invoice_total_hour'].' HOURS' : '' ?></p>
                </td>
                <td style="width: 20%; border:1px solid #000;padding: 5px;">
                    <p style="margin:0; padding: 0;text-align: center;vertical-align: bottom;text-transform:uppercase;"><?= $data['invoice_price_hour'] && $data['invoice_price_hour'] != '-' ? $data['invoice_price_hour'] : '' ?></p>
                </td>
                <td style="width: 20%; border:1px solid #000;padding: 5px;">
